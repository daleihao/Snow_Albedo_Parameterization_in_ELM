...
plot_figure <- plot_grid(   plot_RF1 ,plot_RF2 + theme(legend.position="none"),
                            labels = c("(a)", "(b)"),
                            #%vjust = 0,
                            label_size = 10,
                            nrow = 2, ncol = 1, align = 'v')
ggsave(paste0(Season,"_RF_comparison_TP.tiff"), plot = plot_figure, width = 22, height = 12, units = "cm", dpi = 300, limitsize = FALSE, compression = "lzw")
}
