...
for Season_i = {'Spring'}
    ...
    FSNO_shp4 = Data_shp4s.SnowCovers_all;
    ...
    %% difference
    filter =  elevations>1500 & FSNO_shp1>=0.5;
    difference_1 = abs(difference_1);
    difference_2 = abs(difference_2);
    difference_3 = abs(difference_3);
    difference_4 = abs(difference_4);
    difference_BC = abs(difference_BC);
    difference_dust = abs(difference_dust);
    difference_BC4 = abs(difference_BC4);
    difference_dust4 = abs(difference_dust4);
    
    
    meanAD = [nanmean(difference_4(filter))
        nanmean(difference_BC(filter))
        nanmean(difference_BC4(filter))
        nanmean(difference_dust(filter))
        nanmean(difference_dust4(filter))];
    meanRD = [nanmean(difference_4(filter)./data_shp1(filter))
        nanmean(difference_BC(filter)./data_shp1(filter))
        nanmean(difference_BC4(filter)./data_shp1(filter))
        nanmean(difference_dust(filter)./data_shp1(filter))
        nanmean(difference_dust4(filter)./data_shp1(filter))];
    maxAD = [nanmax(difference_4(filter))
        nanmax(difference_BC(filter))
        nanmax(difference_BC4(filter))
        nanmax(difference_dust(filter))
        nanmax(difference_dust4(filter))];
    maxRD = [nanmax(difference_4(filter)./data_shp1(filter))
        nanmax(difference_BC(filter)./data_shp1(filter))
        nanmax(difference_BC4(filter)./data_shp1(filter))
        nanmax(difference_dust(filter)./data_shp1(filter))
        nanmax(difference_dust4(filter)./data_shp1(filter))];
    Ds = [maxAD maxRD meanAD meanRD];
    ...
    filter = FSNO_class==3 & elevations>1500 & FSNO_shp1>0.01;
    nanmean(difference_2(filter))
    nanmean(difference_3(filter))
    nanmean(difference_4(filter))
    nanmean(difference_2(filter)./data_shp1(filter))
    nanmean(difference_3(filter)./data_shp1(filter))
    nanmean(difference_4(filter)./data_shp1(filter))
    ...
    difference_BC4 = abs(difference_BC4);
    difference_dust4 = abs(difference_dust4);
    filter =  elevations>1500 & FSNO_shp1>=0.5 & abs(difference_4./data_shp1)<1 & ...
        abs(difference_BC./data_shp1)<1 & ...
        abs(difference_BC4./data_shp1)<1 & ...
        abs(difference_dust./data_shp1)<1 & ...
        abs(difference_dust4./data_shp1)<1 ;
    ...
    filter = FSNO_class==4 & elevations>1500 & FSNO_shp1>0.01;
    disp('aaaaaaaaaaaa')
    %     nanmean(difference_2(filter))
    %     nanmean(difference_3(filter))
    %     nanmean(difference_4(filter))
