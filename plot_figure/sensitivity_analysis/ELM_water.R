...
all_datas <- as.data.frame(all_data_import['SnowmeltData'])  
...
plot_1 <- all_data %>%
  ...
  ylab(expression(bold(Delta~(mm/day)))) + 
  ggtitle('Snowmelt') + 
...
# net solar radiation
all_datas <- as.data.frame(all_data_import['ETData'])  
colnames(all_datas) <- c('elevation','snow_filter','snow_cover', 'shape1', 'shape2', 'shape3', 'shape4', 'BC', 'dust','BC4','dust4')
...
# surface temperature
all_datas <- as.data.frame(all_data_import['RunoffData'])  
colnames(all_datas) <- c('elevation','snow_filter','snow_cover', 'shape1', 'shape2', 'shape3', 'shape4', 'BC', 'dust','BC4','dust4')
...
ggsave(paste0(Season,"_Water_shape_comparison_TP_revise.tiff"), plot = plot_figure, width = 18, height = 10, units = "cm", dpi = 300, limitsize = FALSE, compression = "lzw")
...
ggsave(paste0(Season,"_Water_mixing_comparison_TP_revise.tiff"), plot = plot_figure, width = 18, height = 10, units = "cm", dpi = 300, limitsize = FALSE, compression = "lzw")
