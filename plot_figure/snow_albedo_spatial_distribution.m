...
%histogram(FSA_shp2(:) - FSA_shp1(:), [-40:1:40])
plot_global_map_RF(lats, lons, difference_BC, -0.02,0, '', 1, 1,'(d)')
...
plot_global_map_RF(lats, lons, difference_dust,  -0.02,0, '', 1, 0,'(e)')
colormap(gca,colors2)
...
plot_global_map_RF(lats, lons, difference_BC4, -0.02,0, '', 1, 0,'(f)')
colormap(gca,colors2)
...
plot_global_map_RF(lats, lons, difference_dust4, -0.02,0, '', 1, 0,'(g)')
colormap(gca,colors2)
...
% %% snow cover
% figure;
print(gcf, '-dtiff', '-r300', ['spatial_map/' Seasonname '_model_snow_albedo_difference.tif'])
