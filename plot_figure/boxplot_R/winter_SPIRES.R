...
# import data
all_datas <- readMat(paste0('winter_SPIRES_ELM.mat'));
...
ggsave(paste0("winter_comparison_Indus.tiff"), plot = plot_figure, width = 28, height = 8, units = "cm", dpi = 300, limitsize = FALSE, compression = "lzw")
