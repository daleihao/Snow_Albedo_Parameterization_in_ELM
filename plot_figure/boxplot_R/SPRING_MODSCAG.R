...
# import data
all_datas <- readMat(paste0('spring_MODSCAG_ELM.mat'));
...
ggsave(paste0("spring_comparison_TP.tiff"), plot = plot_figure, width = 25, height = 8, units = "cm", dpi = 300, limitsize = FALSE, compression = "lzw")
