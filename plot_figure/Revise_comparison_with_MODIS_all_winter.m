...
% %% snow cover
% figure;
print(gcf, '-dtiff', '-r300', 'spatial_map/elm_modis_winter_comparison.tif')
...
save('boxplot_R/revise_winter_SPIRES_ELM_v4.mat','data');
...
save('boxplot_R/revise_winter_MODSCAG_ELM.mat','data')
