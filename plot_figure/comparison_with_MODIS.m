...
%% get MODISACG data
files = dir('MODIS/winter/MODSCAG_*.mat');
num = size(files, 1);
...
%% get MODIS SPIRES
files = dir('MODIS/winter/SPIRES_*.mat');
num = size(files, 1);
...
% %% snow cover
% figure;
% print(gcf, '-dsvg', '-r300', 'fig/snowshape_FSA.svg')

%% plot
filters = IsIndusArea & SnowCovers_annual_MODSCAG>0;
